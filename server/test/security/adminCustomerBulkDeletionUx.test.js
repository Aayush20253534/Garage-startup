...
test("bulk customer deletion is admin-only and restricted to customer accounts", () => {
  ...
  assert.match(routes, /router\.delete\([\s\S]*"\/customers"[\s\S]*authorizeRoles\("ADMIN"\)/);
