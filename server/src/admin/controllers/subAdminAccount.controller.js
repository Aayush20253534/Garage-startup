...
const listAccounts = asyncHandler(async (_req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, "Admin accounts fetched successfully", data));
});
...
const createAccount = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, "Admin account created successfully", data));
});
...
const updateAccount = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, "Admin account updated successfully", data));
});
...
const changePassword = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, "Admin password changed successfully", data));
});
