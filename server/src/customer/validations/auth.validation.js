...
const AUTH_ROLES = [...USER_ROLES, "GARAGE_CONTROLLER", "ADMIN", "SUB_ADMIN", "INTERN", "CUSTOMER_SUPPORT"];
const PASSWORD_RECOVERY_ROLES = [...USER_ROLES, "GARAGE_CONTROLLER", "SUB_ADMIN", "INTERN"];
...
const forgotPasswordValidation = [
  ...
  body("role")
    ...
    .withMessage(
      "Password recovery is available only for customer, garage, controller, sub-admin or intern accounts",
    ),
];
