...
const sections = [
  ...
  { id: "contact", title: "Contact Us", content: <div className="mt-4 rounded-xl border border-line bg-bg-soft p-4 text-sm leading-7 text-muted sm:text-base"><p><strong className="text-ink">Email:</strong> <a className="underline underline-offset-2" href="mailto:support@rovauto.com">support@rovauto.com</a></p><p><strong className="text-ink">Website:</strong> <a className="underline underline-offset-2" href="https://rovauto.com">https://rovauto.com</a></p></div> },
];
