      ...
      >
        ...
        >
          ...
          {loading ? (
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-5 md:grid-cols-4">
              {Array.from({ length: 6 }).map(
                (_, index) => (
                  <div
                    key={index}
                    className="animate-pulse rounded-[22px] border border-line/70 bg-white p-2.5 shadow-sm sm:rounded-[28px] sm:p-3"
                  >
                    <div className="aspect-[4/3] w-full rounded-[16px] bg-bg-soft sm:aspect-[16/10] sm:rounded-[22px]" />

                    <div className="px-1 pb-1 pt-3 sm:px-2 sm:pt-4">
                      <div className="h-4 w-4/5 rounded-full bg-bg-soft sm:h-5" />
            ...
            <div className="grid grid-cols-2 items-start gap-3 sm:grid-cols-3 sm:gap-5 md:grid-cols-4">
                ...
                (category) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`group relative isolate flex min-w-0 flex-col overflow-hidden rounded-[22px] border bg-white p-2.5 shadow-[0_10px_30px_rgba(15,23,42,0.06)] transition duration-200 sm:rounded-[28px] sm:p-3 ${
                        comingSoon
                    ...
                    >
                      <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[16px] bg-bg-soft sm:aspect-[16/10] sm:rounded-[22px]">
                        <SafeImage
                          src={image}
                        ...
                        {!comingSoon && (
                          <>
                            ...
                            <span className="absolute right-2 top-2 grid h-8 w-8 place-items-center rounded-full border border-white/70 bg-white/90 text-gray-950 shadow-sm backdrop-blur transition duration-200 group-hover:bg-[#b9f000] sm:right-3 sm:top-3 sm:h-9 sm:w-9">
                      ...
                      <div className="flex min-h-[58px] min-w-0 items-center px-1 pb-1 pt-3 sm:min-h-[68px] sm:px-2 sm:pt-4">
                        <div className="min-w-0">
                          <h3 className="line-clamp-2 break-words text-[15px] font-bold leading-[1.25] tracking-[-0.01em] text-gray-950 sm:text-lg sm:leading-snug">
                            {category.name}
                          </h3>

                          <p className="mt-1 hidden text-xs font-medium text-muted sm:block">
                            {comingSoon
                              ? "Launching soon"
